...
module.exports = {
  ...
  process: co(function* (sync) {
    ...
    // For each deleted key, convert the key and delete
    // it if it exists.

    // For each updated key, compute the canoncial key,
    // consolidate the item, and update it.

    // For each created item, consolidate the item,
    // save it and register the key.
