 ...
 *
 * Note: this method can also be used as a converter.
 *
 * @class Range
 *
...
Range.parse = function (options) {
  if (options instanceof Range) return options;
  return new Range(options).validate();
};
