...
function Range(options, limit) {
  ...
  default:
    options = { start: options, limit: limit };
  }
...
properties(Range.prototype, {
  ...
  to: {
    get: function () {
      ...
      return this.finite ? Math.max(this.total - 1, to) : to;
    }
  },
  ...
  open: {
    ...
    get: function () {
      return this.open || this.finite && this.to >= this.total;
    }
  }
});
