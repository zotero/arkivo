 ...
 *
 * @returns {Promise<Subscription>} The new subscription.
 */
 ...
 *
 * @param {Object} values
 * @returns {Object} The filtered values.
 */
 ...
 * @static
 *
 * @returns {Promise<Number>} The number of Subscriptions.
 */
 ...
 *
 * @param {Object|Range}
 * @returns {Promise<Array>} The list of ids.
 */
 ...
 * @static
 *
 * @returns {Promise<Array>} The list of Subscriptions.
 */
...
Subscription.prototype.destroy = co(function* (options) {
  ...
  if (options) {
    ...
    if (options.keys === 'invalidate' && this.key)
 ...
 *
 * This make the key unusable for future API calls!
 *
 * @return {Promise<this>}
 */
Subscription.invalidate = co(function* () {
