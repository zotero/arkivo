...
Synchronization.prototype.update = co(function* () {
  ...
  debug('%s: versions %d received (was %d)',
...
// TODO move this to Synchronizer!
...
Synchronizer.prototype.synchronize = co(function* (subscription) {
  ...
  yield synchronization.execute();


  yield synchronization.process(); // move this out of sync object!
